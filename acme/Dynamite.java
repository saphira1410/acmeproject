...
public class Dynamite {
	...
	/**
	 * Generates a report showing the number of roadrunners killed based on the number of kill attempts made.
	 * @param killAttempts the number of roadrunner kill attempts
	 * @return the number of roadrunners actually killed
	 */
	public int generateDynamiteReport(int killAttempts) {
		rrAttempts = killAttempts * 0;
		return rrAttempts;
